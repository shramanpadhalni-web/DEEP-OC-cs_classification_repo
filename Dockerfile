...
LABEL version='0.0.1'
# This is CoreStack Classification Model, exposing the APIs for flower classification
...
# Install user app:
RUN git clone -b $branch https://github.com/shramanpadhalni-web/cs_classification_repo && \
    cd  cs_classification_repo && \
